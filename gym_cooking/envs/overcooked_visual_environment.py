"""
Similar to the original overcookedEnv
The modifications are: 
1. limit action to (0,0), (1,0), (0,1), (-1, 0), (0, -1)
2. obs = pygame renderred visual RGB pixel 84x84x3
3. remove object oriented observationm, including unneccessary copy.copy 
"""
...
class OvercookedVisualEnvironment(gym.Env):
    ...
    def reset(self):
        ...
        return self.game.get_image_obs(resize=True) # 84,84,3  observation
    ...
    def step(self, action_dict):
        ...
        image_obs = self.game.get_image_obs(resize=True)
